    ...
    [
        #{
            ...
            routes => [
                ...
                docs(~"/docs/learn/orientation", asobi_site_docs_learn_orientation_view),
                docs(~"/docs/learn/bundle", asobi_site_docs_learn_bundle_view),
                docs(~"/docs/learn/install-sdk", asobi_site_docs_learn_install_sdk_view),
                docs(~"/docs/learn/connect", asobi_site_docs_learn_connect_view),
                docs(~"/docs/learn/identity", asobi_site_docs_learn_identity_view),
                docs(~"/docs/learn/storage", asobi_site_docs_learn_storage_view),
                docs(~"/docs/learn/match-setup", asobi_site_docs_learn_match_setup_view),
                docs(~"/docs/learn/match-join", asobi_site_docs_learn_match_join_view),
                docs(~"/docs/learn/match-run", asobi_site_docs_learn_match_run_view),
                docs(~"/docs/learn/match-end", asobi_site_docs_learn_match_end_view),
                docs(~"/docs/learn/world-create", asobi_site_docs_learn_world_create_view),
                docs(~"/docs/learn/world-join", asobi_site_docs_learn_world_join_view),
                docs(~"/docs/learn/world-run", asobi_site_docs_learn_world_run_view),
                docs(~"/docs/learn/world-end", asobi_site_docs_learn_world_end_view),
                docs(~"/docs/learn/where-next", asobi_site_docs_learn_where_next_view),
