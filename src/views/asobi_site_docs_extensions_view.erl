...
See [WebSocket protocol](https://asobi.dev/docs/protocols/websocket) for the frames either side of
...
adding nodes does not widen it. The buckets that are counted per node are the
HTTP and connect limiters - see [Clustering](https://asobi.dev/docs/clustering).
...
[Extending the operator console](https://hexdocs.pm/asobi/console-extensions.html). `/api/v1/ops/features`
...
with no `game` table at all - see [Bots](https://asobi.dev/docs/lua/bots) - so a binding declaring
...
- [Extending the operator console](https://hexdocs.pm/asobi/console-extensions.html) - screens for the
  actions declared above.
- [WebSocket protocol](https://asobi.dev/docs/protocols/websocket) - the frame `rpc.call` lives in.
- [Operator console](https://hexdocs.pm/asobi/console.html) - turning the ops plane on.
- [Clustering](https://asobi.dev/docs/clustering) - what is per node and what is not.
- [Lua API](https://hexdocs.pm/asobi/lua-api.html) - the `game.*` surface your namespace joins.
""".
