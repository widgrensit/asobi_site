...
[Sandbox model](https://asobi.dev/docs/security/lua-sandbox). This page is the complement: what it does
...
boundary](https://asobi.dev/docs/security/lua-trust-model#handle-input-is-not-a-sandbox-boundary).
...
[Known limitations](https://asobi.dev/docs/security/known-limitations#the-release-tree-in-the-container-is-writable)
...
- [Trust model](https://asobi.dev/docs/security/lua-trust-model) - what it is and is not a boundary against.
