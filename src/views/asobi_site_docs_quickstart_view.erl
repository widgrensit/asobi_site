...
render(_Bindings) ->
    Content = ?html({'div', [], [
        ...
        {'div', [{class, ~"docs-callout"}], [
            {p, [], [{strong, [], [~"Prerequisites: "]}, ~"Erlang/OTP 28+, rebar3, Docker (for Postgres), and a terminal."]}
        ]},
...
"""),
        ...
        {'div', [{class, ~"docs-callout docs-callout-success"}], [
            {p, [], [{strong, [], [~"That's it. "]}, ~"You have a live Asobi server running a Lua game with hot-reload deploys."]}
        ]},
